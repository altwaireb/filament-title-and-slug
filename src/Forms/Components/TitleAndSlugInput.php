...
namespace Altwaireb\Filament\Forms\Components;
...
class TitleAndSlugInput
{
    public static function make(
        ...
        $fieldTitle = $fieldTitle ?? config('title-and-slug.field_title');
        $fieldSlug = $fieldSlug ?? config('title-and-slug.field_slug');
        $urlHost = $urlHost ?? config('title-with-and.url_host');
